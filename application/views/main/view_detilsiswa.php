                  ...
                  <tr>
                    <th scope="col">Angkatan</th>
                      ...
                      <td class="text-center">
                        <?php echo anchor('main/peristiwa/print_id/'.$y->nim,'<em class="fa fa-print btn btn-sm btn-danger"> PRINT </em>');?>
                      </td>
              </table>
            </div> 
          </div><?php }?>
            ...
            foreach($data as $smt=>$d)
            {
              ...
              <table id="example" class="table table-bordered">
                <tr class="bg-black">
                  ...
                  if(count($array_ipk)== 0) echo "<center><b>Saat ini Taruna belum memiliki catatan Penghargaan maupun Pelanggaran </b> </center>";
                    ...
                    echo "<center><b>IPK : ".array_sum($array_ipk)/count($array_ipk)."</b></center> ";
                  ?>
                  </td>
                </tr>
                  <?php
              ...
              <?php } ?>
               ...
               <!--  <div class="form-group">
                  <input type="hidden" class="form-control" name="ipk" value="<?php echo $hasil_ipk?>">
                </div> -->
